...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private void registerSmithing(Consumer<FinishedRecipe> pFinishedRecipeConsumer, TagKey<Item> upgradeItem, Item baseItem, Item craftItem) {
    ...
    private void registerSmithing(Consumer<FinishedRecipe> pFinishedRecipeConsumer, Item upgradeItem, Item baseItem, Item craftItem) {
        UpgradeRecipeBuilder.smithing(Ingredient.of(baseItem), Ingredient.of(upgradeItem), craftItem)
                .unlocks("has_" + upgradeItem, has(upgradeItem))
                .save(pFinishedRecipeConsumer, getItemId(craftItem, "_smithing"));
    }

    private ResourceLocation getItemId(Item item, String suffix) {
